          ...
          <div className="col d-flex justify-content-center">
            <div className="card Favcard">
              <div className='card-body text-center F1'>
                <h1 className='p-4 head1'>Completes <i class="fas fa-check-circle text-white"></i></h1>
                ...
                :
                <h5 className='text-white'>You Don't Have Any Complete Todo</h5>
                    }
                </div>
                <p className='card-text text-center'><Link to='/frontend/' style={{color:'white', textDecoration:'none'}} ><i class="fas fa-arrow-left"></i> Back To Home Page</Link></p>
              </div>
            </div>
          </div>
        </div>
